...
if (!html.includes('app.js?v=94')) throw new Error('Pages HTML is not v94');
if (!serviceWorker.includes("period-helper-v94")) throw new Error('Service Worker is not v94');
...
console.log(JSON.stringify({ page: 'v94', serviceWorker: 'v94', worker: health.service, github: 'ok', tokenExpiresAt: status.tokenExpiresAt }, null, 2));
