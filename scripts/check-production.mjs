...
if (!html.includes('app.js?v=92')) throw new Error('Pages HTML is not v92');
if (!serviceWorker.includes("period-helper-v92")) throw new Error('Service Worker is not v92');
...
console.log(JSON.stringify({ page: 'v92', serviceWorker: 'v92', worker: health.service, github: 'ok', tokenExpiresAt: status.tokenExpiresAt }, null, 2));
